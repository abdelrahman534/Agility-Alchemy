...
<head>
  ...
  <meta property="og:description" content="Welcome to Agility Alchemy, your one-stop destination for online training.">
  ...
  <main>
    ...
    <section class="mainSection">
      <article class="mainSection--hero">
        <img src="images/mr-lee-f4RBYsY2hxA-unsplash.jpg" alt="Agility Alchemist" />
      ...
      <article class="mainSection--aboutUs" id='about'>
        ...
        <div class="aboutUs--desc">
          <h2>ABOUT US</h2>
          <p>Welcome to Agility Alchemist, where online training meets convenience. Founded by four ambitious college
            students, we're dedicated to making fitness and skill development accessible from the comfort of your home.
            Our platform offers personalized training programs designed to fit your schedule and goals. Join us and
        ...
        <div class="mainSection--services" id='services'>
          ...
          <div class="service">
            ...
            <div class="service--desc">
              ...
              <p>Personalized training programs tailored to individual fitness levels, goals, and preferences. Users can
                access a wide range of workout routines, exercises, and progress tracking tools to achieve their desired
                results.
              </p>
            </div>
          </div>
          <div class="service">
            ...
            <div class="service--desc">
              ...
              <p>Comprehensive resources and guidance on nutrition, meal planning, and general wellness to support
                overall health and fitness goals. Users can access articles, recipes, meal plans, and nutritional tips
          ...
          <div class="service">
            ...
            <div class="service--desc">
              ...
              <p>Targeted training videos focusing on specific fitness goals, such as fat loss, muscle gain, endurance,
                or rehabilitation. Each program is designed to address specific needs and objectives, providing users
          ...
          <div class="service">
            ...
            <div class="service--desc">
              ...
              <p> Access to our vast database of workout videos, tutorials, and tips covering a wide range of fitness
                disciplines and skill levels. Users can explore and choose from a variety of workouts tailored to their
                preferences and goals, providing endless options for effective and enjoyable home training.</p>
            </div>
          </div>
        </div>
      </article>
    ...
    <footer id="contact">
      <div class="footer--container">
        ...
        <div class="footer--socialMedia">
          ...
          <a href="https://www.linkedin.com/in/adel-ashraf-3a9445231/"><img src="images/linkedin.png" alt="LinkedInIcon" /></a>
        ...
        <div class="footer--copyRight">
          <p>Copyright © 2024 Agility Alchemist. All rights reserved.
            ...
            All content, including text, graphics, logos, images, videos, and audio files, on the Agility Alchemist
            website is the property of Agility Alchemist and is protected by copyright laws. Any unauthorized
            reproduction, distribution, or modification of the content is strictly prohibited without prior written
            consent from Agility Alchemist.

            Agility Alchemist and its logo are trademarks of Agility Alchemist. All other trademarks, service marks, and
            trade names mentioned on the website are the property of their respective owners.

            For inquiries regarding the use of content or trademarks, please contact us at adelashrafmuhammed@gmail.com.
          </p>
        </div>
      </div>
    </footer>
